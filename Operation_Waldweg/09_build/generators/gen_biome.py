...
BUILD = os.path.dirname(HERE)                      # .../09_build
ROOT = os.path.dirname(BUILD)                      # .../Operation_Waldweg
...
CASE = os.environ.get('WALDWEG_CASE_MASTER', os.path.join(BUILD, 'case_master.yaml'))
