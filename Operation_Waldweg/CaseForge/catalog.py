...
def main():
    ...
    ap.add_argument("--out", default=os.path.join(HERE, "..", "06_master", "Artefakt_Katalog.md"))
    ap.add_argument("--csv", default=os.path.join(HERE, "..", "06_master", "Artefakt_Katalog.csv"))
